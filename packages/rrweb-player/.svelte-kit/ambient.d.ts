...
declare module '$env/static/private' {
	...
	export const CRAFT_LOG_LEVEL: string;
	...
	export const CRAFT_OLD_VERSION: string;
	...
	export const GITHUB_ACTION_PATH: string;
	...
	export const CRAFT_NEW_VERSION: string;
